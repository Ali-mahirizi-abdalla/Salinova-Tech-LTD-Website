    ...
    <div>
      ...
      <section className="py-20 text-center border-b border-teal/10">
        <div className="container mx-auto px-6 lg:px-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Salinova Tech LTD</h1>
      ...
      <section className="py-20 relative z-10">
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl text-center">
          ...
          <div className="space-y-6 text-text-muted text-lg leading-relaxed">
            ...
            <p className="text-white font-medium">Our long-term ambition: become one of Africa's leading technology companies—recognized for innovation, trust, and excellence.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {["Free Coding Workshops", "Scholarships", "Mentorship Programs", "Digital Literacy Campaigns", "Environmental Sustainability"].map(item => (
              <span key={item} className="px-4 py-2 bg-navy-light rounded-full text-white border border-teal/20">{item}</span>
            ))}
          </div>
